...
const DEFAULT_HERO = {
  ...
  title: 'Your Health, Our Priority with',
  titleHighlight: 'Premium Parapharmacy Products',
  description:
    'Discover quality healthcare products, medical supplies, and wellness solutions from certified professionals. Expert advice and personalized care for your health journey.',
  features: [
  ...
  imageUrl:
    'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?q=80&w=1920&auto=format&fit=crop',
  imageAlt: 'Modern pharmacy interior with healthcare products',
  statsLabel1: 'Customer Trust',
  statsValue1: '98% Satisfaction',
  statsLabel2: 'Products',
  statsValue2: '5000+ Items',
} as const;
